...
Each topic has five depth levels — **junior → middle → senior → professional** — plus an **interview** Q&A bank and hands-on **tasks**. Start at your level and climb. The topics build on each other loosely: concurrency and the runtime (01–02) explain *why* Go behaves the way it does; interfaces and errors (03–04) are the design vocabulary you use everywhere; HTTP, data, and debugging (05–07) are where all of it gets exercised under real traffic.

---

> Part of [Software Engineering](../../README.md) — Programming Languages.
