...
- [Prompt Engineering](../04-prompt-engineering/) — writing the instructions the agent reasons over
- [Tools / Actions](../05-tools-actions/) — the actions side of the loop
- [Agent Memory](../07-agent-memory/) — what persists across loop iterations
- [Agent Architectures](../08-agent-architectures/) — named patterns built on this loop
