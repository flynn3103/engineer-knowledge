# Claims, Evidence, and Reasoning — Professional
...
1. What is calibration, and how do you make a conclusion as confident as the evidence allows but no more?
2. What is steelmanning and why do it before refuting?
3. Your A/B test shows the overall conversion rate improved, but you suspect something's off. What could a single aggregate number hide?
4. Brandolini's law says refuting nonsense costs ~10× more than producing it. As a tech lead, how do you defend a team against confident-but-wrong claims?
