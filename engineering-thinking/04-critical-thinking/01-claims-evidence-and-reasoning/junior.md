# Claims, Evidence, and Reasoning — Junior
...
1. Decompose this into claim, evidence, and reasoning: "We should rewrite the parser in Rust because it'll be faster."
2. What's the difference between an anecdote, a measurement, and a proof?
3. Rank these from weakest to strongest evidence that a service is slow: a production flame graph, "it feels slow," a microbenchmark, a single timeout report, a load test.
