...
- The hardest exercises — distributed/concurrent procedures and approximate-vs-exact choices — are in [check your understanding](#check-your-understanding) and [check your understanding](#check-your-understanding).
...
1. How do you decide between divide & conquer, greedy, DP, and backtracking?
2. Give me a case where greedy looks right but is wrong.
3. What's the difference between "I have an idea" and "I have an algorithm"?
4. When is an *approximate* answer the right engineering choice?
