...
- Apply the reasoning in [check your understanding](#check-your-understanding) — invariant-writing and strategy-selection drills.
...
1. How do you convince yourself (or me) that a loop is correct?
2. How do you reason about edge cases systematically?
3. How do you know a loop or recursion terminates?
4. You estimate a solution is `O(n²)`. Is that good or bad?
