# Constraint-Driven Creativity — Middle
...
1. Name a self-imposed constraint you'd use to break a stuck design.
2. How does a tight latency budget produce a *better* architecture, not just a faster one?
3. What's the difference between an essential and an assumed constraint?
4. A teammate says "we can't do this, we don't have the memory." How do you respond?
