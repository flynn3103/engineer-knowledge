...
1. "Treat the database like a filesystem." What's wrong with this?
2. Design patterns are sometimes called "crystallized analogies." Explain.
3. Why is analogy a hypothesis generator but not a proof?
4. Give an example where interrogating the *real* source domain flips the conclusion.
