# Experiments and A/B Testing — Professional
...
- [check your understanding](#check-your-understanding) — rapid-fire checks on the traps.
- [check your understanding](#check-your-understanding) — design, debug, and compute exercises.
...
1. Your new social feature shows a huge lift. Why might it be fake, even with clean stats?
2. What's the novelty effect and how do you control for it?
3. State Twyman's law and how it changes your behavior.
4. How is a canary release the same as an A/B test, and how does it differ?
