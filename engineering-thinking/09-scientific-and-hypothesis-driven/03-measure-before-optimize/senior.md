# Measure Before Optimize — Senior
...
1. Difference between a micro-benchmark and a macro-benchmark, and when to use each?
2. What's the observer effect in profiling, and which profiler avoids it?
3. You optimized something and it's 3% faster. Ship it?
4. When is the correct answer "stop optimizing"?
