...
1. What is "devising a plan" in Pólya's framework, and how is it different from coding?
2. You're handed an unfamiliar problem and have no idea how to start. What do you do?
3. Explain "solve a simpler version first" with an engineering example.
