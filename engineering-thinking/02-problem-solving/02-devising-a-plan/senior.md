...
1. What is the "riskiest-part-first" principle, and why does it matter?
2. How can a plan be "concrete enough to check but not coding-in-disguise"?
3. When should you NOT make a plan and just start coding?
4. Why call a plan a "hypothesis"?
