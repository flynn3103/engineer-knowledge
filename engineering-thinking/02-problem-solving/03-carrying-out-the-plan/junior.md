...
1. What does Pólya mean by "check each step" in the carry-out stage?
2. Why is verifying each step better than verifying at the end?
3. Your plan hits an obstacle mid-execution. A step fails. What do you do?
