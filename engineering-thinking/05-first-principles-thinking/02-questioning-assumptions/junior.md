...
1. What's the difference between an explicit and an implicit assumption?
2. How do you tell a *load-bearing* assumption from an *incidental* one?
3. Walk me through how you'd surface the hidden assumptions in this requirement: "Email users a daily summary at 9am."
4. Name some techniques for surfacing assumptions and when each fits.
