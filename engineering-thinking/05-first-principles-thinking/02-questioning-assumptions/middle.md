...
1. Give a concrete example of a "falsehood programmers believe" and a bug it causes.
2. Your colleague says "we can't run that report in real time, it takes 40 minutes." How do you respond?
3. How do you validate an assumption *cheaply* before betting the architecture on it?
4. Explain the cost asymmetry that justifies all this effort.
