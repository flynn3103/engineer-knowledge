...
1. Map the PID controller terms to a system you'd build.
2. How would you size a circuit breaker as a loop parameter?
3. Give an example of a destructive *reinforcing loop in process*, not code.
4. The single highest-leverage intervention in a feedback loop is usually what?
