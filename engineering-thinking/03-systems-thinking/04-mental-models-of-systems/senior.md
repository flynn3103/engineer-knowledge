# Mental Models of Systems — Senior
...
1. What is model drift, and how do you defend against it?
2. "The map is not the territory." What's its practical consequence for an engineer?
3. Name reusable mental models every backend engineer should carry.
4. How do USE and RED function as mental models rather than just metrics?
