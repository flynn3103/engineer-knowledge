# Leverage Points and Bottlenecks — Middle
...
1. A function is 5% of total runtime. You make it 100× faster. What's the overall speedup?
2. "You optimized X and nothing got faster." Give every reason this happens.
3. What does Donella Meadows mean by "people find leverage points but push them in the wrong direction"?
4. Order these by leverage, weakest to strongest: a goal, a timeout value, a feedback loop's delay, the system's paradigm.
