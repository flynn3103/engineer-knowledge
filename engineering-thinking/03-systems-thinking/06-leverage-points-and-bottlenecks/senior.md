# Leverage Points and Bottlenecks — Senior
...
1. The page takes 4 seconds and users blame the frontend. Where do you look first, and why might the frontend be the wrong place?
2. Your DB shows 1800ms of wait per request but the DB CPU is at 3%. What's the constraint?
3. One flaky test fails 1-in-5 CI runs and CI must be green to merge. Why is this a high-leverage fix?
4. After you fix the bottleneck, what happens — and what's the discipline?
