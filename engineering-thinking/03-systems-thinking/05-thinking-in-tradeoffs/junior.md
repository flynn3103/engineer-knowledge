...
1. What does "there is no free lunch" mean in engineering?
2. Explain the difference between latency and throughput, and why they trade off.
3. State the CAP theorem precisely. What's the common misstatement?
