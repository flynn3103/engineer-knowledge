...
1. What is Tell-Don't-Ask, and why is it useful?
2. Critique this snippet: `if (loan.getStatus() == APPROVED) loan.setStatus(DISBURSED);`
3. Is Tell-Don't-Ask the same as the Law of Demeter?
4. How does Tell-Don't-Ask overlap with Command-Query Separation?
5. When is "asking" legitimate?
