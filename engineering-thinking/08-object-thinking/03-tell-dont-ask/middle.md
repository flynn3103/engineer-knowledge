...
1. Walk me through refactoring `a.getB().getC().doSomething(x)`.
2. How does Tell-Don't-Ask change how you write tests?
3. What are the trade-offs against functional or data-oriented styles?
4. Critique this "telling" method.
5. How does Tell-Don't-Ask interact with JPA / Hibernate?
