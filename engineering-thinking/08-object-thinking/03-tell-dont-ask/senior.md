...
1. How can Tell-Don't-Ask discipline help you avoid N+1 queries?
2. Design a `LoanApplication.disburse(...)` flow in telling style.
3. "Should I just delete every getter in my codebase?"
4. Pattern matching on sealed types vs asking — when is each appropriate?
5. What's the single best heuristic for spotting an "ask" smell during code review?
