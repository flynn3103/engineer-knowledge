...
1. A teammate says "fields first is faster, behavior emerges later." How do you respond?
2. How does behavior-first interact with Domain-Driven Design?
3. How does behavior-first thinking affect testability?
4. Sketch a class that has behavior but no fields.
5. How would you onboard a team that has shipped an anemic codebase for years?
6. Give a small snippet that violates behavior-first and rewrite it.
7. The future of behavior-first in Java — what helps, what hurts?
