...
1. How do you decide whether a method belongs on the object or on a service?
2. Critique this class.
3. What is feature envy and how does it relate to behavior-first?
4. How would you refactor a 30-getter, 2-method class?
5. Walk me through designing an `Order` class behavior-first. Start with the verbs.
6. Is a `record` an anemic class? Defend your answer.
7. Name a Java framework that *fights* behavior-first design and explain why.
