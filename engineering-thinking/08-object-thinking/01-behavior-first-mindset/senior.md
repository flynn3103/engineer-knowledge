...
1. How do you spot a hidden service-class problem during code review?
2. How does behavior-first thinking interact with JPA/Hibernate?
3. How do you keep behavior in the domain when DTOs cross the wire?
4. When does behavior-first hurt rather than help?
5. How does behavior-first interact with serialization frameworks like Jackson?
6. What's the cost of going too far — making everything a rich object?
