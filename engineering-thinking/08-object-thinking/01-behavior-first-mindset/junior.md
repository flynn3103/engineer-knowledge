...
1. Explain the difference between data-first and behavior-first object design.
2. Why does David West call OOP a "culture of behavior"?
3. What is the anemic domain model and why is it an anti-pattern?
4. When would you intentionally choose an anemic structure?
5. What does "Tell, Don't Ask" mean? Give an example.
6. Why does West call the noun-and-verb approach "paradigm tourism"?
