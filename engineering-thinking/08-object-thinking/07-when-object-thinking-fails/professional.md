...
| Hands-on "pick the paradigm" exercises                         | [check your understanding](#check-your-understanding)         |
| Interview Q&A on paradigm choice and trade-offs                | [check your understanding](#check-your-understanding)     |
...
1. Walk through: when would you choose ECS over OO inheritance?
2. Where does the `*Service` class hide a function in disguise?
3. When would you reach for streams + records instead of a domain object?
4. What signals tell you that a codebase has *too much* Object Thinking, and what would you change?
5. Final question — give me a single rule for "when to leave Object Thinking."
