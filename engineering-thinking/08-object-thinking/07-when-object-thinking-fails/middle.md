...
| Interview Q&A on paradigm trade-offs                               | [check your understanding](#check-your-understanding)     |
...
1. Critique this snippet — a `*Manager` doing CSV parsing.
2. What does Project Valhalla aim to fix?
3. Joe Armstrong's "gorilla holding the banana" — explain.
4. Steve Yegge's "Kingdom of Nouns" critique — agree or disagree?
5. When should DTOs stay anemic on purpose?
