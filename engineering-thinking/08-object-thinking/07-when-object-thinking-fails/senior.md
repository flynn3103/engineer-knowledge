...
1. Design a hot path — OO vs DoD walkthrough.
2. How do you mix paradigms in one Java codebase without chaos?
3. "If OO has limits, why use it at all?" — defend the choice.
4. Records vs classes — where does each fit?
