...
| Interview Q&A on bounded contexts and aggregates                   | [check your understanding](#check-your-understanding)    |
...
1. Compare Event Storming, CRC cards, and UML — when do you use each?
2. What is a value object, and when does something become an entity?
3. What is an aggregate root, and how do you pick one?
4. Critique this anaemic model.
5. How do you handle invariants that span multiple aggregates?
