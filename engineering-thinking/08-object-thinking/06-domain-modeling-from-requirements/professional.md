...
| Hands-on workshop exercises                                    | [check your understanding](#check-your-understanding)                                        |
| Interview Q&A on running modeling practices                    | [check your understanding](#check-your-understanding)                                    |
...
1. Money in domain models: `double` vs `BigDecimal` vs a `Money` value object?
2. When is domain modeling overkill — should you just write CRUD?
3. How do you involve domain experts without overwhelming them with code?
4. Defend the choice of a rich aggregate against a teammate who insists on "thin entities + fat services".
5. How do domain events fit into the model, and where do you publish them from?
