...
| Interview Q&A on bounded contexts, event sourcing, consistency     | [check your understanding](#check-your-understanding)        |
...
1. Critique: a "Service" doing what the aggregate should.
2. How does domain modeling interact with JPA / Hibernate?
3. Walk me through modeling an auction.
4. How do you know when the model is wrong? Give red flags.
