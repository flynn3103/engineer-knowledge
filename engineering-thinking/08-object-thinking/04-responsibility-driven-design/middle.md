...
| Interview Q&A on RDD vs anemic/service-oriented designs                     | [check your understanding](#check-your-understanding)    |
...
1. How does RDD relate to DDD and aggregates?
2. Critique a class that mixes every stereotype.
3. Critique a coordinator that's secretly a god class.
4. How do you decide whether a responsibility belongs to an existing class or a new one?
5. When should a Coordinator be introduced?
