...
1. What are the trade-offs of RDD versus functional designs?
2. Should every class declare its stereotype explicitly?
3. How do you migrate a legacy anemic-domain Spring application toward RDD?
4. What if a responsibility seems to belong to *no* domain object?
5. What's the single most important habit to develop?
