...
1. What is the "anemic Information Holder" trap?
2. How do you enforce stereotype direction in code review?
3. Walk through designing a `LoanOrigination` flow using RDD.
4. How does RDD interact with frameworks like Spring and JPA?
