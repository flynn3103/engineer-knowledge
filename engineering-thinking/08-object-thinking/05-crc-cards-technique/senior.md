...
5. **Write tests against the skeletons** (junior [check your understanding](#check-your-understanding) style) before filling them in.
...
1. Walk through a CRC design for a hotel booking system.
2. How do CRC sessions go wrong in practice?
3. What are the best practices when translating cards into Java packages?
4. When should you *not* use CRC?
5. How do you choose between splitting a fat card and adding a new collaborator?
