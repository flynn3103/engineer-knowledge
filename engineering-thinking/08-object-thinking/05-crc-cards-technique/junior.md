...
1. What does CRC stand for, and who invented the technique?
2. What belongs on a CRC card, and what is deliberately left off?
3. How do you pick the initial set of candidate classes?
4. What does the role-play walk-through actually accomplish?
5. CRC versus UML class diagrams — when does each win?
