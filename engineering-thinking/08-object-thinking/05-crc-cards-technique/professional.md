...
1. What does a CRC pile look like when the design is finished?
2. What is the "anthropomorphic" critique of CRC, and how do you respond?
3. How does CRC interact with TDD when you start writing code?
4. How do you defend CRC to a sceptical team lead who calls it "playing with paper"?
5. What does a senior engineer take *away* from a CRC session into the codebase?
