...
1. CRC versus Event Storming — when does each fit?
2. How does CRC connect to RDD stereotypes?
3. Critique this card. Is the responsibility list actually a field list?
4. When do you stop drawing cards?
5. Should CRC sessions be done remotely, and if so, how?
