...
| Hands-on role-play exercises                                         | [check your understanding](#check-your-understanding)        |
...
1. How do you teach this style to a team that has only written CRUD services?
2. Walk me through designing a `LoanApplication` agent. What does it say about itself?
3. What is the relationship between anthropomorphism and DDD aggregates?
4. How does anthropomorphism interact with framework-driven code (JPA, Jackson, Spring)?
