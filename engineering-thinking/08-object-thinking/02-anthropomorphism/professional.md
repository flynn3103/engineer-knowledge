...
| Hands-on role-play exercises and rewrite drills      | [check your understanding](#check-your-understanding)         |
| Interview Q&A                                        | [check your understanding](#check-your-understanding)     |
...
1. Is anthropomorphism just an OOP thing, or does it apply to functional and procedural code too?
2. When does anthropomorphism conflict with performance or simplicity?
3. In a code review, what concrete signals tell you anthropomorphism has been ignored?
4. What is the "god-agent" anti-pattern, and how do you avoid it?
5. If you had to summarize anthropomorphism as a single rule for a code-review checklist, what would it be?
