...
| Hands-on workshop exercises across multiple domains                    | [check your understanding](#check-your-understanding)         |
| Interview Q&A — defending the heuristic                                | [check your understanding](#check-your-understanding)     |
...
1. Compare a polymorphic chess piece design with a switch-on-type design.
2. "Objects are not really alive" — how do you defend the heuristic against that objection?
3. How does anthropomorphism relate to encapsulation, tell-don't-ask, and feature envy?
4. Critique this method name: `OrderProcessor.processOrder(Order)`. What is wrong?
5. Give an example where forcing anthropomorphism is harmful.
