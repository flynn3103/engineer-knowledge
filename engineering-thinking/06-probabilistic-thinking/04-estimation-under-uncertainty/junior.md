# Estimation Under Uncertainty — Junior
...
1. Why give a range instead of a single number?
2. Estimate the QPS for a service handling 50 million requests per day. (Worked Fermi)
3. Estimate the storage for 10 years of logs from a service doing 1,000 writes/sec, each log ~500 bytes. (Worked Fermi)
