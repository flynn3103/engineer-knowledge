# Reasoning Under Uncertainty — Junior
...
| Practice problems | [check your understanding](#check-your-understanding) |
...
1. What does it mean to say "I'm 70% sure" about a one-off event that can never repeat?
2. State Bayes' theorem and explain each term in engineering language.
3. The classic. A test for a rare disease is 99% accurate. The disease affects 1 in 10,000 people. You test positive. What's the probability you have it?
