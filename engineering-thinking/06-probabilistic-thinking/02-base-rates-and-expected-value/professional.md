# Base Rates and Expected Value — Professional
...
1. A test is 95% accurate for a bug that appears in 1% of builds. The test fires. P(real bug)?
2. Reference-class forecasting says a migration is ~8 days; your gut says 4. Which do you commit to and why?
3. Build vs buy — frame it as EV.
4. Give a one-line decision rule that combines everything.
