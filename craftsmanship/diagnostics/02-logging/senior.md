...
> Which system invariant is affected by **Logging** under failure, load, and change?
...
1. State the system invariant that **Logging** must protect.
...
- Which invariant must remain true when Logging fails?
