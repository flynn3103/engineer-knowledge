...
> Part of the [Craftsmanship](../README.md) roadmap. It pairs well with [Legacy Code](../legacy-code/README.md): both reduce uncertainty before and during risky changes.
