...
- [Continuous Profiling](../continuous-profiling/README.md) — always-on, fleet-wide stack sampling (the productionized cousin of A2/A3).
- [Tracing](../tracing/README.md) — distributed request tracing; eBPF can feed and correlate with it.
- [Metrics](../metrics/README.md) — aggregate counters/histograms; eBPF maps are a metrics source.
- [Logging](../logging/README.md) — event records; contrast with eBPF's structured, low-overhead events.
- [Debugging](../debugging/README.md) — interactive and post-mortem techniques alongside live instrumentation.
- [Observability Engineering](../observability-engineering/README.md) — how instrumentation, traces, metrics, and logs combine into a coherent practice.
