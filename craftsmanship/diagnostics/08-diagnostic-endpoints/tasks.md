...
- If the impact is too high, the answer is continuous profiling (always-on, low-overhead sampling). See [`../12-continuous-profiling/README.md`](../12-continuous-profiling/README.md) and the `profiling-techniques` skill.
...
- [Diagnostic Endpoints — Interview](interview.md)
- Sibling diagnostic topics: [Debugging](../01-debugging/README.md), [Logging](../02-logging/README.md), [Metrics](../04-metrics/README.md), [Continuous Profiling](../12-continuous-profiling/README.md)
