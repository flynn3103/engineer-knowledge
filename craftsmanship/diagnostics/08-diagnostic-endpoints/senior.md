# Diagnostic Endpoints — Senior

<!-- level-focus -->
At senior level, focus on this question:

> Which system invariant is affected by **Diagnostic Endpoints** under failure, load, and change?
...
1. State the system invariant that **Diagnostic Endpoints** must protect.
...
- Which invariant must remain true when Diagnostic Endpoints fails?
