...
Explain the mechanism, not just the rule. This guide keeps the topic practical: separate facts from preference; make a rationale and next step explicit.
...
- separate facts from preference; make a rationale and next step explicit.
