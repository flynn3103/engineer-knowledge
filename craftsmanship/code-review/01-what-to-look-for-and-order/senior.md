# What to Look For & Review Order — Senior

## Purpose

Reason from first principles across system boundaries. This guide keeps the topic practical: calibrate review depth using blast radius, invariants, and evidence.
...
- calibrate review depth using blast radius, invariants, and evidence.
