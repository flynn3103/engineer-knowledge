# What to Look For & Review Order — Junior

## Purpose

Learn the vocabulary and follow a repeatable checklist. This guide keeps the topic practical: read context first, then test behavior and inspect the risky paths.
...
- read context first, then test behavior and inspect the risky paths.
