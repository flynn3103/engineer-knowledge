...
Learn the vocabulary and follow a repeatable checklist. This guide keeps the topic practical: identify inputs and outputs; use local cache without trusting stale artifacts.
...
- identify inputs and outputs; use local cache without trusting stale artifacts.
