...
Explain the mechanism, not just the rule. This guide keeps the topic practical: model targets, actions, sandboxes, and content-addressed cache keys.
...
- model targets, actions, sandboxes, and content-addressed cache keys.
