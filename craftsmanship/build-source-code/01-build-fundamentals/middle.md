# Build Fundamentals — Middle

## Purpose

Explain the mechanism, not just the rule. This guide keeps the topic practical: inspect translation units, symbols, ABI, and loader behavior.
...
- inspect translation units, symbols, ABI, and loader behavior.
