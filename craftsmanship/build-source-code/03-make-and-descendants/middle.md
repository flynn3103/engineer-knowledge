...
Explain the mechanism, not just the rule. This guide keeps the topic practical: use patterns, generated headers, order-only prerequisites, Ninja, and CMake.
...
- use patterns, generated headers, order-only prerequisites, Ninja, and CMake.
