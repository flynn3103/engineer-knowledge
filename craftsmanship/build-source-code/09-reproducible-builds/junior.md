# Reproducible Builds — Junior

## Purpose

Learn the vocabulary and follow a repeatable checklist. This guide keeps the topic practical: make the same inputs produce the same artifact; compare hashes.
...
- make the same inputs produce the same artifact; compare hashes.
