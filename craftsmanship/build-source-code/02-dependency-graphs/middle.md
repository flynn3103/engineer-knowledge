...
Explain the mechanism, not just the rule. This guide keeps the topic practical: make dependencies complete; use hashes when timestamps are unreliable.
...
- make dependencies complete; use hashes when timestamps are unreliable.
