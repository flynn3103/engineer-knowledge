...
- Architecture Anti-Patterns — when the wrong structure is a *system* decision (the wrong store, not the wrong collection).
...
1. Explain Wrong Data Structure — Senior Level in your own words and name the problem it solves.
2. How would you apply the ideas around Table of Contents, Introduction, Prerequisites in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you validate a system-level decision about Wrong Data Structure — Senior Level under uncertainty?
