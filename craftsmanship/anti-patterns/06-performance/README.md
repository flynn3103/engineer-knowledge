...
> A progressive engineering roadmap for turning performance principles into repeatable decisions, observable practices, and maintainable systems.
...
| # | Topic | Focus |
|---|---|---|
| 01 | [Premature Optimization Traps](01-premature-optimization-traps/junior.md) | Build practical judgment in premature optimization traps. |
| 02 | [N Plus One in Code](02-n-plus-one-in-code/junior.md) | Build practical judgment in n plus one in code. |
| 03 | [Unnecessary Allocation](03-unnecessary-allocation/junior.md) | Build practical judgment in unnecessary allocation. |
| 04 | [Wrong Data Structure](04-wrong-data-structure/junior.md) | Build practical judgment in wrong data structure. |
