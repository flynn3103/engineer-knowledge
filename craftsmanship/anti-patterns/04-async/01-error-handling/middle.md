...
- **Helpful:** Familiarity with synchronous error-handling principles — the async versions are the same ideas under a microtask delay.
...
1. Explain Async Error-Handling Anti-Patterns — Middle Level in your own words and name the problem it solves.
2. How would you apply the ideas around Table of Contents, Introduction, Prerequisites in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. Which local design trade-off would make you choose or reject Async Error-Handling Anti-Patterns — Middle Level in an existing codebase?
