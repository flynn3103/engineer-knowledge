# OO Misuse Anti-Patterns — Junior
...
**Why it's bad:** with no boundaries, invariants can't be protected and a change anywhere can break state anywhere — it's the encapsulation failure behind [Anemic Domain Model](#anemic-domain-model). **Fix:** private fields + accessor/behavior methods; favor immutability.
...
|---|---|---|
| **Anemic Domain Model** | Domain class is all get/set, logic in a `…Service` | Move behavior onto the object; private fields (Tell, Don't Ask) |
| **Flag Arguments** | Boolean param flips behavior; `if flag` first line | Two named methods, or an enum |
| **Telescoping Constructor** | >3 params or `this(...)` overload chain | Builder / named arguments |
...
| **Call Super** | Subclass must call `super.x()` or it breaks | Template Method with a hook |
...
1. Explain OO Misuse Anti-Patterns — Junior Level in your own words and name the problem it solves.
2. How would you apply the ideas around Table of Contents, Introduction, Prerequisites in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. What small example would prove that you can apply OO Misuse Anti-Patterns — Junior Level correctly?
