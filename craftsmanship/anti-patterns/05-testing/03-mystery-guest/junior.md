...
- Architecture Anti-Patterns — the same diseases one level up, in system structure.

---

## Check your understanding

1. Explain Mystery Guest — Junior Level in your own words and name the problem it solves.
2. How would you apply the ideas around Table of Contents, Introduction, Prerequisites in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. What small example would prove that you can apply Mystery Guest — Junior Level correctly?
