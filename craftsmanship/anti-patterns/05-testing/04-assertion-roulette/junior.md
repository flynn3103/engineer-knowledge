...
- Architecture Anti-Patterns — the larger-scale shapes these test smells defend against.
...
1. Explain Assertion Roulette — Junior Level in your own words and name the problem it solves.
2. How would you apply the ideas around Table of Contents, Introduction, Prerequisites in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. What small example would prove that you can apply Assertion Roulette — Junior Level correctly?
