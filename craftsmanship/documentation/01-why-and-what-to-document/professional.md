...
Document information that changes a reader's decision: intent, constraints, contracts, risks, and recovery steps.
...
For a change, name the audience and the question they need answered. Put the answer beside the work or link to its source of truth.

Do not narrate obvious code or copy facts that another source already owns.
