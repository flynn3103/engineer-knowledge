...
Give an on-call engineer safe, observable steps to diagnose, mitigate, verify, and escalate.
...
Start from a trigger, include guardrails and rollback, and test the procedure in realistic conditions.

Do not rely on memory, destructive copy-paste commands, or stale escalation paths.
