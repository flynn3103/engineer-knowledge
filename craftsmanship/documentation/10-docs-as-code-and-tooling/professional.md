...
Treat documentation as a versioned product with review, checks, builds, and publishable artifacts.
...
Keep docs near their source when possible and automate links, formatting, examples, and builds.

Do not make tooling a gate without useful failures or leave generated output as the only editable source.
