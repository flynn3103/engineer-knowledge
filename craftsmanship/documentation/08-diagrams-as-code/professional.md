...
Use versioned, reviewable diagram source to explain structure, flows, and boundaries.
...
Choose the smallest diagram that answers one question and keep labels tied to real system terms.

Do not use decorative diagrams, duplicate every detail, or store the editable source elsewhere.
