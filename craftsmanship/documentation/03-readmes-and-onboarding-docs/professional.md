...
Help a new contributor understand the project, run it locally, and make a safe first change.
...
Keep setup commands tested, state prerequisites, and link to deeper design and operational material.

Do not turn the README into an unstructured dump or assume tribal knowledge.
