...
Align people before implementation by making the problem, options, risks, and validation plan explicit.
...
Write the smallest proposal that lets reviewers challenge assumptions and choose a direction.

Do not present a preferred solution as the problem or hide unresolved trade-offs.
