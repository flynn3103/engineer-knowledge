...
Related smells: Fragile Base Class Problem, Composition over Inheritance, [Refused Bequest](../04-refused-bequest/).
...
2. How would you apply the ideas around Six symptoms of a yo-yo in the wild, Symptom 1 — the IDE 10-hop trace, Symptom 2 — the alternating stack trace in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. Which local design trade-off would make you choose or reject Yo-Yo Problem in an existing codebase?
