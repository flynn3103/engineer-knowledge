...
2. How would you apply the ideas around The name and the picture, A minimal yo-yo, Why this is bad — even when each layer is "clean" in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. What small example would prove that you can apply Yo-Yo Problem correctly?
