...
**Anemic Domain Model** means domain objects holding data while services contain all business decisions. It is useful only when it makes ownership, change, or correctness easier to see.

## Recognize it

Look for:

- getters/setters everywhere, procedural service methods, and invalid state assembled in callers.
...
**Default move:** move invariants and domain behavior to the object that owns the state.
