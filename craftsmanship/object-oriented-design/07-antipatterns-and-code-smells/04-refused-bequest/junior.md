...
2. How would you apply the ideas around The smell in one paragraph, The canonical example: ImmutableList extends ArrayList, What the JDK itself does — and why it's still a smell in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. What small example would prove that you can apply Refused Bequest correctly?
