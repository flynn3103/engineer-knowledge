...
**Refused Bequest** means a subtype inheriting behavior or data it cannot honor. It is useful only when it makes ownership, change, or correctness easier to see.

## Recognize it

Look for:

- overridden methods that reject work, unused inherited members, and type checks around subclasses.
...
**Default move:** replace the inheritance relationship with composition or a smaller abstraction.
