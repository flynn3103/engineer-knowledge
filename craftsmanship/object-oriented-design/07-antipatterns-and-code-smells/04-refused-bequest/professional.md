...
1. Explain Refused Bequest — Professional Level in your own words and name the problem it solves.
2. How would you apply the ideas around Why "professional" means "automated", The smell in the JDK itself, Detection — ArchUnit rules in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you introduce and govern Refused Bequest — Professional Level across teams through reversible, measurable increments?
