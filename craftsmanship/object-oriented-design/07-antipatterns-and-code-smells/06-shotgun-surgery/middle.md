...
2. How would you apply the ideas around The four causes worth knowing, Cause 1 — Scattered responsibility (pricing across services), Cause 2 — Copy-paste of behaviour (validation rules) in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. Which local design trade-off would make you choose or reject Shotgun Surgery in an existing codebase?
