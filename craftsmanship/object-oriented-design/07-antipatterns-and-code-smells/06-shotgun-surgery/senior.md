...
2. How would you apply the ideas around From gut feeling to evidence, Classifying clusters before refactoring, Strategy — when variants change independently in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you validate a system-level decision about Shotgun Surgery under uncertainty?
