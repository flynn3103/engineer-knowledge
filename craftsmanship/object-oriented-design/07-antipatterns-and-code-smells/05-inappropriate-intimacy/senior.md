...
2. How would you apply the ideas around Parnas, 1972 — the original argument, Java's access modifiers — designed to fail, Encapsulation breaks below the language level in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you validate a system-level decision about Inappropriate Intimacy under uncertainty?
