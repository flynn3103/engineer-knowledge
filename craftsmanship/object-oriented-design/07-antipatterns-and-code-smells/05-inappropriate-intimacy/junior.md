...
| Topic                                                       | Where                                                  |
| ----------------------------------------------------------- | ------------------------------------------------------ |
| The forces behind the smell: cohesion vs coupling, CBO      | `../../03-design-principles/04-cohesion-and-coupling/` |
...
1. Explain Inappropriate Intimacy in your own words and name the problem it solves.
2. How would you apply the ideas around The point of Inappropriate Intimacy in one sentence, The C++ "friend" analogy, A small worked example — Order and Customer in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. What small example would prove that you can apply Inappropriate Intimacy correctly?
