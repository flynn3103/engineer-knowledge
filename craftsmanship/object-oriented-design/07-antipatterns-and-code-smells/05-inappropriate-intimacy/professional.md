...
2. How would you apply the ideas around JPMS — modules that physically hide their internals, ArchUnit — boundary rules enforced as tests, Hexagonal architecture — the domain in the centre in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you introduce and govern Inappropriate Intimacy across teams through reversible, measurable increments?
