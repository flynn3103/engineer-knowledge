...
2. How would you apply the ideas around Symptoms first, refactor second, Move Method — `Order` doing `Customer`'s work, Move Field — `Customer.lastOrderTotal` belongs to `Order` in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. Which local design trade-off would make you choose or reject Inappropriate Intimacy in an existing codebase?
