...
2. How would you apply the ideas around Value Objects in DDD — what the term actually means, Tiny types — the micro-types movement, The Money trap — `double`, `long cents`, and `BigDecimal` in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you validate a system-level decision about Primitive Obsession under uncertainty?
