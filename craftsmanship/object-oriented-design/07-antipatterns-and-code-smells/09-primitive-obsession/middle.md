...
2. How would you apply the ideas around Why a refactoring catalog beats ad-hoc fixes, Replace Data Value with Object — `String` to `Email`, Validation in the compact constructor in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. Which local design trade-off would make you choose or reject Primitive Obsession in an existing codebase?
