...
- Immutability patterns — value objects are immutable by default.
...
1. Explain Primitive Obsession in your own words and name the problem it solves.
2. How would you apply the ideas around The point in one sentence, The canonical bug — swapped arguments, The other canonical bug — naked `int` for money in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. What small example would prove that you can apply Primitive Obsession correctly?
