...
2. How would you apply the ideas around Project Valhalla in one paragraph, ArchUnit — forbidding raw primitives in domain APIs, A migration playbook for a legacy codebase in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you introduce and govern Primitive Obsession across teams through reversible, measurable increments?
