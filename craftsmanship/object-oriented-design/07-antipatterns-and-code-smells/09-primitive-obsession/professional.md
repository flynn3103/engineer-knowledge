...
**Primitive Obsession** means strings, numbers, and booleans representing concepts with rules of their own. It is useful only when it makes ownership, change, or correctness easier to see.

## Recognize it

Look for:

- format checks scattered across callers, magic values, and invalid combinations.
...
**Default move:** replace primitives with small value objects, enums, or policy types.
