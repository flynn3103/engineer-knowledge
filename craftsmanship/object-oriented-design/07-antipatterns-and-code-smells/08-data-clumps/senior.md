...
**Data Clumps** means the same group of values travelling together without a named concept. It is useful only when it makes ownership, change, or correctness easier to see.

## Recognize it

Look for:

- repeated parameter groups, parallel fields, and duplicated validation.
...
**Default move:** introduce a value object with meaningful behavior and validation.
