...
1. Explain God Class in your own words and name the problem it solves.
2. How would you apply the ideas around Three forces that grow God Classes, The damage, in priority order, The refactoring sequence in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. Which local design trade-off would make you choose or reject God Class in an existing codebase?
