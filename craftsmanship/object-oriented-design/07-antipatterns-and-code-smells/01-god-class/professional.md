...
1. Explain God Class — Professional Level in your own words and name the problem it solves.
2. How would you apply the ideas around Architectural Prevention, DDD Aggregates — One Root, One Invariant Boundary, Hexagonal Architecture — Push Infrastructure Out in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you introduce and govern God Class — Professional Level across teams through reversible, measurable increments?
