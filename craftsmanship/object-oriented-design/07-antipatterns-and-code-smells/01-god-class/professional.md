...
**God Class** means one object accumulating unrelated responsibilities, state, and dependencies. It is useful only when it makes ownership, change, or correctness easier to see.

## Recognize it

Look for:

- large constructors, many reasons to change, broad tests, and frequent merge conflicts.
...
**Default move:** extract cohesive collaborators behind narrow interfaces.
