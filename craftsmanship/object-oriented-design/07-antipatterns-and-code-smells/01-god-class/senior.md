...
2. How would you apply the ideas around The metrics that name the smell, Running the detection in CI, The Marinescu/Lanza *Detection Strategy* in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you validate a system-level decision about God Class under uncertainty?
