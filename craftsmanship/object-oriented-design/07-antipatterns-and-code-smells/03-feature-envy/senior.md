...
| Law of Demeter — the chains that co-occur with envy    | `../../03-design-principles/03-law-of-demeter/`                  |
| Cohesion & coupling — what Move Method actually buys   | `../../03-design-principles/04-cohesion-and-coupling/`    |
...
2. How would you apply the ideas around Envy as a numerical signal, not a binary, Strategy — envy that is the point of the pattern, Visitor — envy formalised as a pattern in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you validate a system-level decision about Feature Envy under uncertainty?
