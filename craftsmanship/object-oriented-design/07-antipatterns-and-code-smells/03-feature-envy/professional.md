...
2. How would you apply the ideas around Service Layer envy — the anemic domain model symptom, DTO envy — mapping logic in the wrong place, Cross-aggregate envy in DDD in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you introduce and govern Feature Envy across teams through reversible, measurable increments?
