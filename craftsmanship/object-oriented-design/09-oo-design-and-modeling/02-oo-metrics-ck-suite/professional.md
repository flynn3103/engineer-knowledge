# OO Metrics: CK Suite — Professional
...
**OO Metrics: CK Suite** means using CK metrics as signals for design risk, not automatic verdicts. It is useful only when it makes ownership, change, or correctness easier to see.

## Recognize it

Look for:

- high complexity, coupling, inheritance depth, or response surface hides change risk.
...
**Default move:** baseline metrics, inspect outliers, and improve the underlying design.
