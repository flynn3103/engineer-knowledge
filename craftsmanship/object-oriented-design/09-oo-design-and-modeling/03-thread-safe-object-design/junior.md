...
- ../../04-object-contracts-and-semantics/05-immutability-and-defensive-copying/ — immutability is the simplest thread-safety strategy.
...
2. How would you apply the ideas around Thread safety is a property of a class, not a feeling, A race condition is a broken invariant, not a crash, Strategy 1 — confinement: the state nobody shares can't race in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. What small example would prove that you can apply Thread-Safe Object Design correctly?
