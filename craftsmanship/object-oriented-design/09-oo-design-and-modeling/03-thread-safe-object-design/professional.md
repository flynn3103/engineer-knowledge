...
- ../../04-object-contracts-and-semantics/05-immutability-and-defensive-copying/professional.md — driving immutability (the cheapest safety) across a codebase.
...
2. How would you apply the ideas around The first review question: "what's the synchronization policy?", error-prone: compile-time `@GuardedBy` enforcement, SpotBugs / FindBugs concurrency detectors in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you introduce and govern Thread-Safe Object Design across teams through reversible, measurable increments?
