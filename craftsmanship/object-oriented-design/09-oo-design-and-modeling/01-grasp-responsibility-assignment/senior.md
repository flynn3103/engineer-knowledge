...
2. How would you apply the ideas around The master tension: Information Expert vs. Low Coupling, Pure Fabrication vs. the anemic domain model, Controller bloat — the cohesion failure mode in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you validate a system-level decision about GRASP under uncertainty?
