...
2. How would you apply the ideas around The four seam shapes, side by side, Strategy — the default seam, Template Method — fixed skeleton, varying steps in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. Which local design trade-off would make you choose or reject Designing for Extension & Polymorphism in an existing codebase?
