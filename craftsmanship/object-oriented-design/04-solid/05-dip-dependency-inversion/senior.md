...
> **Level:** senior. A concise guide for applying this design principle.

## Core idea

High-level policy and low-level details should depend on an abstraction owned by the policy.
