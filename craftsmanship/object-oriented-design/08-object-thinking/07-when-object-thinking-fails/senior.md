...
2. How would you apply the ideas around JVM mechanics that make OO costly in hot paths, Project Valhalla and value classes, Project Loom and virtual threads in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you validate a system-level decision about When Object Thinking Fails under uncertainty?
