...
2. How would you apply the ideas around The same task, three paradigms, Bench-style cost comparison, Extracting a pure function from a behavior-first object in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. Which local design trade-off would make you choose or reject When Object Thinking Fails in an existing codebase?
