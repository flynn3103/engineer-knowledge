...
**When Object Thinking Fails** means recognizing when object models add indirection without improving the problem. It is useful only when it makes ownership, change, or correctness easier to see.

## Recognize it

Look for:

- tiny transformations acquire layers, factories, and speculative hierarchies.
...
**Default move:** use plain data and functions when behavior, invariants, and collaboration are minimal.
