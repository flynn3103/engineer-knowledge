...
**Behavior-First Mindset** means model what an object can do before exposing what it stores. It is useful only when it makes ownership, change, or correctness easier to see.

## Recognize it

Look for:

- callers manipulate fields and coordinate rules themselves.
...
**Default move:** start from capabilities, invariants, and collaborations.
