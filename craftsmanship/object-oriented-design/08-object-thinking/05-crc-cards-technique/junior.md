...
```mermaid
flowchart LR
    ORDER["Order<br/>knows items<br/>computes total<br/>places itself<br/>marks shipped"]
    LINE["LineItem"]
    MONEY["Money"]
    INVENTORY["InventoryService"]
    ORDER -->|item details| LINE
    ORDER -->|total value| MONEY
    ORDER -->|reserve stock| INVENTORY
```

The central node names the class and its responsibilities; outgoing arrows identify its collaborators. That's it. No fields or method signatures—just behaviors and who helps.

The point of leaving implementation code out is to delay technical decisions until you understand the model. You can argue about who *owns* a responsibility without first arguing about return types.
...
| Hands-on CRC card exercises                                      | [check your understanding](#check-your-understanding)         |
...
1. Explain CRC Cards in your own words and name the problem it solves.
2. How would you apply the ideas around The card layout, The workflow, end to end, Why physical cards (or sticky notes) in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. What small example would prove that you can apply CRC Cards correctly?
