...
2. How would you apply the ideas around Running a 90-minute CRC workshop — the facilitation script, When to call a CRC session, Templates in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you introduce and govern CRC Cards across teams through reversible, measurable increments?
