# CRC Cards Technique — Professional
...
**CRC Cards Technique** means using Class–Responsibility–Collaboration cards to test a design conversation. It is useful only when it makes ownership, change, or correctness easier to see.

## Recognize it

Look for:

- a design is hard to explain or one card owns every scenario.
...
**Default move:** walk one use case with cards and revise overloaded responsibilities.
