...
2. How would you apply the ideas around Where CRC stops being enough, CRC vs Event Storming — when to use which, CRC vs UML class and sequence diagrams in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you validate a system-level decision about CRC Cards under uncertainty?
