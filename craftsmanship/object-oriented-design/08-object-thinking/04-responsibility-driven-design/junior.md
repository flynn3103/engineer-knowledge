...
2. How would you apply the ideas around The core question: who owns this?, Why responsibilities, not data?, The six classic stereotypes in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. What small example would prove that you can apply Responsibility-Driven Design correctly?
