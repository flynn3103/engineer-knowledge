...
**Responsibility-Driven Design** means assign behavior to focused objects that collaborate through clear messages. It is useful only when it makes ownership, change, or correctness easier to see.

## Recognize it

Look for:

- classes are named by data or framework role rather than a reason to act.
...
**Default move:** list responsibilities and collaborators before choosing fields or methods.
