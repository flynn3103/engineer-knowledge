...
```mermaid
flowchart TD
    CTRL["Controllers<br/>Interfacers"] --> SVC["Services<br/>Providers and Coordinators"]
    SVC --> ENTITY["Entities<br/>Information Holders and Controllers"]
    SVC --> REPO["Repositories<br/>Interfacers"]
```
...
```mermaid
flowchart LR
    IN["Inbound adapters<br/>Interfacers"] --> APP["Application services<br/>Coordinators"]
    APP --> DOMAIN["Domain<br/>Holders, Controllers, Providers"]
    APP --> PORT["Outbound port"]
    OUT["Outbound adapter<br/>Interfacer"] --> PORT
```
...
| Hands-on RDD exercises                                         | [check your understanding](#check-your-understanding)         |
...
2. How would you apply the ideas around RDD vs SOLID — overlap and difference, RDD and DDD — stereotypes map to tactical patterns, Designing for testability — each stereotype has its own test style in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you validate a system-level decision about Responsibility-Driven Design under uncertainty?
