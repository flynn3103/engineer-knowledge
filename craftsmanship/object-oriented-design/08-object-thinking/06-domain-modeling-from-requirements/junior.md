...
(More on this in ../../08-tactical-ddd/.)
...
| Hands-on modeling exercises                                    | [check your understanding](#check-your-understanding)         |
...
2. How would you apply the ideas around The traditional recipe — and why it leads astray, A better starting point: events and decisions, A worked walk-through — meeting room reservations in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. What small example would prove that you can apply Domain Modeling from Requirements correctly?
