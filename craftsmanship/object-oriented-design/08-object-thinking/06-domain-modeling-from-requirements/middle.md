...
```mermaid
flowchart LR
    SUBMITTED["Application submitted"] --> APPLICATION["Application"]
    APPLICATION --> DOCUMENTS["Documents requested"]
    DOCUMENTS --> CREDIT["Credit report pulled"]
    CREDIT --> SCORE["Risk score assigned"]
    SCORE --> APPROVED["Underwriting approved"]
    APPROVED --> LOAN["Loan funded"]
    LOAN --> SERVICING["Servicing started"]
```
...
| Hands-on exercises: storm a domain, derive aggregates              | [check your understanding](#check-your-understanding)        |
...
1. Explain Domain Modeling from Requirements in your own words and name the problem it solves.
2. How would you apply the ideas around Event Storming basics — the four colors that matter, Bounded contexts — drawing the lines, From events to aggregates — grouping the stickies in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. Which local design trade-off would make you choose or reject Domain Modeling from Requirements in an existing codebase?
