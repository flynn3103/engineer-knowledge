...
| Hands-on modeling exercises across legacy and greenfield domains   | [check your understanding](#check-your-understanding)            |
...
2. How would you apply the ideas around When the model must fight a legacy schema, CRUD vs domain models — when each is appropriate, Microservice boundaries based on bounded contexts in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you validate a system-level decision about Domain Modeling from Requirements under uncertainty?
