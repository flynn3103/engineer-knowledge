...
2. How would you apply the ideas around Where the metaphor fails in real codebases, Object roles taxonomy (preview of RDD), Stateless agents — can you anthropomorphize a `TaxRule`? in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you validate a system-level decision about Anthropomorphism under uncertainty?
