...
2. How would you apply the ideas around The agent-verb workshop, CRC-card-lite for the claim domain, Refactoring `Utils.calculateX(thing)` into agent methods in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. Which local design trade-off would make you choose or reject Anthropomorphism in an existing codebase?
