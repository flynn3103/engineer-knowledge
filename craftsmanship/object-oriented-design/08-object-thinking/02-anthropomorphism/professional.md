...
**Anthropomorphism** means using domain language to discover an object’s responsibilities. It is useful only when it makes ownership, change, or correctness easier to see.

## Recognize it

Look for:

- nouns become passive records and verbs become giant services.
...
**Default move:** ask what each domain concept knows, decides, and delegates.
