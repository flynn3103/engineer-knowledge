...
The third case is sometimes called *train-wreck* code—a long chain of attribute navigation. It's a Law-of-Demeter violation (see [Law of Demeter](../../02-coupling-and-cohesion/04-law-of-demeter/)) and a tell-don't-ask smell in one.
...
| Hands-on refactoring exercises                                 | [check your understanding](#check-your-understanding)         |
...
2. How would you apply the ideas around The smell, in one snippet, Why "asking" feels natural — and is wrong, A worked example — an elevator in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. What small example would prove that you can apply Tell, Don't Ask correctly?
