...
2. How would you apply the ideas around Where Tell-Don't-Ask legitimately breaks down, Tell-Don't-Ask across the persistence boundary, The conversation pattern — rich object dialogues in a realistic engineering change?
3. What failure mode or misuse should you look for, and what evidence would reveal it?
4. How would you validate a system-level decision about Tell, Don't Ask under uncertainty?
