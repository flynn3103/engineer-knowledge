...
>
> Looking for *profiling* (CPU / memory / lock contention)? See [Quality Engineering → Performance → Profiling](../../../../Software-Engineering/quality-engineering/performance/01-profiling/).
>
