...
- [Metrics — Interview](interview.md)
- Sibling diagnostic topics: [Logging](../02-logging/README.md), [Tracing](../05-tracing/README.md) — where identity (`user_id`, `request_id`) belongs.
