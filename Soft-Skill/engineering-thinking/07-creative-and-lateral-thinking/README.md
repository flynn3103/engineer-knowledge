...
Each topic has five depth levels — **junior → middle → senior → professional** — plus an **interview** Q&A bank and hands-on **tasks**. Start at your level and climb. Read 01 first to frame the create-then-filter cycle; 02–04 are three independent generators you can reach for when stuck.
