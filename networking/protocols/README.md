...
| 05 | [WebSockets](websockets/junior.md) | Operate a bidirectional connection safely. |
| 06 | [Server-Sent Events](server-sent-events/junior.md) | Deliver resumable server-to-client events. |
| 07 | [Long Polling and Streaming](long-polling-and-streaming/junior.md) | Match delivery style to update behavior. |
| 08 | [Proxies and NAT](network-proxies-and-nat/junior.md) | Trace address translation and forwarded identity. |
| 09 | [Congestion Control and TCP Tuning](congestion-control-and-tcp-tuning/junior.md) | Measure before tuning throughput or latency. |
| 10 | [Container and Overlay Networking](container-and-overlay-networking/junior.md) | Follow packets across namespaces and overlays. |
| 11 | [BGP and Internet Routing](bgp-and-internet-routing/junior.md) | Reason about path selection and blast radius. |
