# Cloud Network Architecture (VPC)

> Build practical capability in Cloud Network Architecture (VPC) through four levels of increasing scope, ambiguity, and responsibility.
