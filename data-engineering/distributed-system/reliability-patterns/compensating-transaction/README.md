...
pivot point (see [Saga: Orchestration vs Choreography](../../distributed-transaction/saga-orchestration-vs-choreography/README.md))
requiring special handling.

## Related

- [Saga: Orchestration vs Choreography](../../distributed-transaction/saga-orchestration-vs-choreography/README.md)
- [Atomic Commit: 2PC, 3PC, TCC](../../coordination/atomic-commit-2pc-3pc-tcc/README.md)
