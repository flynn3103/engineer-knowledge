...
- See also: [Cache-Aside — professional](../../../databases/operation/caching/01-cache-aside/professional.md)
  (Redis internals), [Write-Behind — professional](../../17-background-jobs/03-returning-results/professional.md).
