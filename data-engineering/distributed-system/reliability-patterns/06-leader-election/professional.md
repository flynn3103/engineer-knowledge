...
[readiness check](../05-health-endpoint-monitoring/README.md) on the
...
[Circuit Breaker](../01-circuit-breaker/README.md) protection as any other
...
Per [Bulkhead](../02-bulkhead/README.md), the connection/thread pool used
...
- See also: [Circuit Breaker — professional](../01-circuit-breaker/professional.md),
  [Bulkhead — professional](../02-bulkhead/professional.md).
