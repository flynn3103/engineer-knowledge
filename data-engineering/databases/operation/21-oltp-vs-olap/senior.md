...
(per [Locking & Concurrency Control — professional](../../transaction/09-locking-and-concurrency-control/professional.md))
...
[Replication](../../scaling/16-replication/README.md) and
