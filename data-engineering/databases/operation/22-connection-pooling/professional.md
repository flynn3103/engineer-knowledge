...
- See also: [Locking & Concurrency Control — professional](../../transaction/09-locking-and-concurrency-control/professional.md),
  [MVCC — professional](../../transaction/10-mvcc/professional.md).
