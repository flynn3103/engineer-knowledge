...
| **TTL-based** | A fixed expiry, independent of access | Predictable staleness bound (ties directly into [Cache-Aside — middle](../01-cache-aside/middle.md)), but can evict still-popular data purely because time passed |
