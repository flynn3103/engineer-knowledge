...
- See also: [Atomic Commit: 2PC/3PC/TCC — professional](../../../distributed-system/18-concurrency-coordination/atomic-commit-2pc-3pc-tcc/professional.md),
  [Compensating Transaction — professional](../../../distributed-system/20-reliability-patterns/compensating-transaction/professional.md).
