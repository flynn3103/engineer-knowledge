...
- [Queue-Based Load Leveling](../../../distributed-system/reliability-patterns/09-queue-based-load-leveling/README.md)
- [Event-Driven Background Jobs — professional](../../../distributed-system/17-background-jobs/01-event-driven/professional.md)
