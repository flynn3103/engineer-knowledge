...
- See also: [Exactly-Once Semantics — professional](../../../distributed-system/18-concurrency-coordination/exactly-once-semantics/professional.md),
  [Retries & Idempotency — professional](../../../distributed-system/17-background-jobs/retries-and-idempotency/professional.md).
