# `go mod vendor` — Middle

<!-- level-focus -->
At middle level, focus on this question:

> Where does **`go mod vendor`** belong in a maintainable component, and which trade-off selects the design?
...
1. Find a real component where **`go mod vendor`** affects an interface or dependency.
...
- Which boundary is most affected by `go mod vendor`?
