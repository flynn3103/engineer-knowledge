# Project Layout — Middle

<!-- level-focus -->
At middle level, focus on this question:

> Where does **Project Layout** belong in a maintainable component, and which trade-off selects the design?
...
1. Find a real component where **Project Layout** affects an interface or dependency.
...
- Which boundary is most affected by Project Layout?
