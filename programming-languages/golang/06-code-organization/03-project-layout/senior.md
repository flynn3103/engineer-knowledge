# Project Layout — Senior

<!-- level-focus -->
At senior level, focus on this question:

> Which system invariant is affected by **Project Layout** under failure, load, and change?
...
1. State the system invariant that **Project Layout** must protect.
...
- Which invariant must remain true when Project Layout fails?
