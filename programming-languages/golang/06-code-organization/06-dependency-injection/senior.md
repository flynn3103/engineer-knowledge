...
> Which system invariant is affected by **Dependency Injection** under failure, load, and change?
...
1. State the system invariant that **Dependency Injection** must protect.
...
- Which invariant must remain true when Dependency Injection fails?
