# Publishing Modules — Middle

<!-- level-focus -->
At middle level, focus on this question:

> Where does **Publishing Modules** belong in a maintainable component, and which trade-off selects the design?
...
1. Find a real component where **Publishing Modules** affects an interface or dependency.
...
- Which boundary is most affected by Publishing Modules?
