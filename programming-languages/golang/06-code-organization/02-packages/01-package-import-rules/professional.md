# Package Import Rules — Professional

<!-- level-focus -->
At professional level, focus on this question:

> How should teams adopt and operate **Package Import Rules** with measurable outcomes and limited coordination?
...
1. Define the user or business outcome that **Package Import Rules** should improve.
...
- Which measurable outcome justifies investing in Package Import Rules?
