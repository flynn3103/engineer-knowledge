# Package Import Rules — Middle

<!-- level-focus -->
At middle level, focus on this question:

> Where does **Package Import Rules** belong in a maintainable component, and which trade-off selects the design?
...
1. Find a real component where **Package Import Rules** affects an interface or dependency.
...
- Which boundary is most affected by Package Import Rules?
