# Using Third-Party Packages — Senior

<!-- level-focus -->
At senior level, focus on this question:

> Which system invariant is affected by **Using Third-Party Packages** under failure, load, and change?
...
1. State the system invariant that **Using Third-Party Packages** must protect.
...
- Which invariant must remain true when Using Third-Party Packages fails?
