# Using Third-Party Packages — Middle

<!-- level-focus -->
At middle level, focus on this question:

> Where does **Using Third-Party Packages** belong in a maintainable component, and which trade-off selects the design?
...
1. Find a real component where **Using Third-Party Packages** affects an interface or dependency.
...
- Which boundary is most affected by Using Third-Party Packages?
