# Module Versioning — Senior

<!-- level-focus -->
At senior level, focus on this question:

> Which system invariant is affected by **Module Versioning** under failure, load, and change?
...
1. State the system invariant that **Module Versioning** must protect.
...
- Which invariant must remain true when Module Versioning fails?
