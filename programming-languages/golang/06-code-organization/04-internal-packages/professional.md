# Internal Packages — Professional

<!-- level-focus -->
At professional level, focus on this question:

> How should teams adopt and operate **Internal Packages** with measurable outcomes and limited coordination?
...
1. Define the user or business outcome that **Internal Packages** should improve.
...
- Which measurable outcome justifies investing in Internal Packages?
