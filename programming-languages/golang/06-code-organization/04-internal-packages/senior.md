# Internal Packages — Senior

<!-- level-focus -->
At senior level, focus on this question:

> Which system invariant is affected by **Internal Packages** under failure, load, and change?
...
1. State the system invariant that **Internal Packages** must protect.
...
- Which invariant must remain true when Internal Packages fails?
