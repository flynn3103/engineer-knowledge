# Internal Packages — Middle

<!-- level-focus -->
At middle level, focus on this question:

> Where does **Internal Packages** belong in a maintainable component, and which trade-off selects the design?
...
1. Find a real component where **Internal Packages** affects an interface or dependency.
...
- Which boundary is most affected by Internal Packages?
