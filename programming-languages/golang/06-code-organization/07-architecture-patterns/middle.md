# Architecture Patterns — Middle

<!-- level-focus -->
At middle level, focus on this question:

> Where does **Architecture Patterns** belong in a maintainable component, and which trade-off selects the design?
...
1. Find a real component where **Architecture Patterns** affects an interface or dependency.
...
- Which boundary is most affected by Architecture Patterns?
