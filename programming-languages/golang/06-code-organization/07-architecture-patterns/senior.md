...
> Which system invariant is affected by **Architecture Patterns** under failure, load, and change?
...
1. State the system invariant that **Architecture Patterns** must protect.
...
- Which invariant must remain true when Architecture Patterns fails?
