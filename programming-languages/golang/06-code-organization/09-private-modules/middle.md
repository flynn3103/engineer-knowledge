# Private Modules — Middle

<!-- level-focus -->
At middle level, focus on this question:

> Where does **Private Modules** belong in a maintainable component, and which trade-off selects the design?
...
1. Find a real component where **Private Modules** affects an interface or dependency.
...
- Which boundary is most affected by Private Modules?
