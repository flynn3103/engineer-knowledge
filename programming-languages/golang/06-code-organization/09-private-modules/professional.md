# Private Modules — Professional

<!-- level-focus -->
At professional level, focus on this question:

> How should teams adopt and operate **Private Modules** with measurable outcomes and limited coordination?
...
1. Define the user or business outcome that **Private Modules** should improve.
...
- Which measurable outcome justifies investing in Private Modules?
