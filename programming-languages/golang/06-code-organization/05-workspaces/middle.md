...
> Where does **Workspaces** belong in a maintainable component, and which trade-off selects the design?
...
1. Find a real component where **Workspaces** affects an interface or dependency.
...
- Which boundary is most affected by Workspaces?
