...
> Which system invariant is affected by **Workspaces** under failure, load, and change?
...
1. State the system invariant that **Workspaces** must protect.
...
- Which invariant must remain true when Workspaces fails?
