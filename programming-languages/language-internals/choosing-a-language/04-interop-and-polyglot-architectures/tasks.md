...
- [ ] The plan is *targeted and incremental* (strangler-fig per service, per [`../06-migrating-between-languages/`](../06-migrating-between-languages/README.md)), not a big-bang rewrite.
