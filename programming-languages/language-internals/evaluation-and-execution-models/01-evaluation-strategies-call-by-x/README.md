# Evaluation Strategies (call-by-x)

> Build practical capability in Evaluation Strategies (call-by-x) through four levels of increasing scope, ambiguity, and responsibility.
