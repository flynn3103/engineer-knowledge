# Reading Codegen (Disassembly & Compiler Output)

> Build practical capability in Reading Codegen (Disassembly & Compiler Output) through four levels of increasing scope, ambiguity, and responsibility.
