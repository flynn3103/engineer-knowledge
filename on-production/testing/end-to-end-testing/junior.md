...
See [Test Strategy & the Pyramid](../test-strategy-and-the-pyramid/README.md) for the full picture.
...
The web-first assertion waits *exactly* as long as needed and no longer. **"`sleep` is a bug"** — engrave it. We'll go deeper on flakiness in [Flaky Tests & Reliability](../flaky-tests-and-reliability/README.md).
