...
- **Beware metric flakiness.** Canary analysis can be flaky for the same reasons tests are — see [flaky tests and reliability](../flaky-tests-and-reliability/README.md). Require N consecutive bad windows, not one, before aborting.
