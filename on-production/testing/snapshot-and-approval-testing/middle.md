# Snapshot & Approval Testing — Middle

<!-- level-focus -->
At middle level, focus on this question:

> Where does **Snapshot & Approval Testing** belong in a maintainable component, and which trade-off selects the design?
...
1. Find a real component where **Snapshot & Approval Testing** affects an interface or dependency.
...
- Which boundary is most affected by Snapshot & Approval Testing?
