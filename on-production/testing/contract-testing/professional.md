...
**The E2E reduction is the strategic payoff.** Before contracts, teams pile up end-to-end tests to catch interface drift — slow, flaky, combinatorial. As contract coverage rises, you can *deliberately delete* most of those E2E tests, keeping only a thin layer for true multi-service *behavior* of critical journeys. The target shape (see the [test pyramid](../test-strategy-and-the-pyramid/professional.md)):
