...
Any of those make the test slow, flaky, or environment-dependent — the opposite of a unit test. (How to *replace* those dependencies in a test is the job of [test doubles](../test-doubles-mocks-fakes/README.md), covered later.)
