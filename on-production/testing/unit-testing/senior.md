...
| Snapshot/approval tests over volatile output | Reserve for stable, reviewed output (see [Snapshot Testing](../snapshot-and-approval-testing/README.md)) |
...
- **Flaky test.** Non-deterministic pass/fail. *Violates everything* — see [Flaky Tests & Reliability](../flaky-tests-and-reliability/README.md). A flaky test is a trust leak; quarantine and fix, never ignore.
...
Anything you can't make deterministic doesn't belong in the unit layer — push it up to integration ([Integration Testing](../integration-testing/README.md)).
