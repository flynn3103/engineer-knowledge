...
4. **Replace cross-service E2E with contract tests at boundaries.** Instead of booting six services to check service A talks to service B, write a contract: A's expectations of B, verified against B in isolation. (See [Contract Testing](../contract-testing/README.md).)
