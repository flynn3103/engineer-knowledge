...
The honest verification that your code works against a real external service is **contract testing** ([contract-testing](../contract-testing/senior.md)) — recording or asserting the real request/response shape against the actual provider — not a mock you invented. Mocks tell you "given my assumptions, my code is consistent"; contract tests tell you "my assumptions match reality."
