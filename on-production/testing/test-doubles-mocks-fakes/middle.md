...
> Caveat: faking an external HTTP API still tests *your model* of that API, which may be wrong. The honest answer is **contract testing** ([contract-testing](../contract-testing/middle.md)) — covered in the senior tier under "don't mock what you don't own."
