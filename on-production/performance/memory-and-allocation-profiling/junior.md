...
- A heap *profile* (captured per [01 — Profiling](../profiling/cpu-profiling/junior.md)) pointed at the exact line; reusing a pooled map collapsed the allocation rate and the latency followed.
