...
- No amount of branchless cleverness will help — the fix is in the cache hierarchy (data layout, prefetch, blocking), which is exactly the [memory-layout and locality](../memory-and-allocation-profiling/senior.md) toolkit.
