...
2. **The GC at 14%** is a downstream symptom; an allocation flame graph (change the metric — see [../allocation-profiling/middle.md](../allocation-profiling/middle.md)) would confirm the marshaller is the allocator too, and fixing #1 likely shrinks both boxes at once.
