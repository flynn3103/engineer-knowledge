...
Memory profiling answers *what is alive in the heap right now, and what keeps it alive*. Distinct from [Allocation Profiling](../allocation-profiling/README.md) (which counts what was *allocated*), this section is about what was *retained*.
...
- **[Allocation Profiling](../allocation-profiling/README.md)** — the *rate* side; usually the easier optimisation target.
- **[Memory Optimization](../../memory-and-allocation-profiling/README.md)** — what to do once you know what's retained.
