...
- **[Memory Profiling](../memory-profiling/README.md)** — what's *retained* (different question, same tool sometimes).
- **[Memory Optimization](../../memory-and-allocation-profiling/README.md)** — reducing rate at the source.
