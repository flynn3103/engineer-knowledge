# CPU Profiling — Middle

<!-- level-focus -->
At middle level, focus on this question:

> Where does **CPU Profiling** belong in a maintainable component, and which trade-off selects the design?
...
1. Find a real component where **CPU Profiling** affects an interface or dependency.
...
- Which boundary is most affected by CPU Profiling?
