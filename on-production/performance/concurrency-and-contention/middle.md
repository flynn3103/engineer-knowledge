# Concurrency and Contention — Middle

<!-- level-focus -->
At middle level, focus on this question:

> Where does **Concurrency and Contention** belong in a maintainable component, and which trade-off selects the design?
...
1. Find a real component where **Concurrency and Contention** affects an interface or dependency.
...
- Which boundary is most affected by Concurrency and Contention?
