# Encryption at Rest and Transit — Senior
...
design protect data while it travels and while it is stored across components under failure and change. In this module, the important vocabulary is **TLS, encryption keys, and authenticated encryption**. Security work is useful only when the system makes the intended decision reliably and produces evidence that it did so.
