# Encryption at Rest and Transit — Middle
...
choose maintainable boundaries for protect data while it travels and while it is stored in a real codebase. In this module, the important vocabulary is **TLS, encryption keys, and authenticated encryption**. Security work is useful only when the system makes the intended decision reliably and produces evidence that it did so.
