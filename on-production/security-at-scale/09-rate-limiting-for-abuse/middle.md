# Rate Limiting for Abuse — Middle
...
choose maintainable boundaries for bound abusive or accidental demand fairly and predictably in a real codebase. In this module, the important vocabulary is **quotas, token buckets, and identity keys**. Security work is useful only when the system makes the intended decision reliably and produces evidence that it did so.
