...
> Build practical capability in DevSecOps and Supply Chain Security through four levels of increasing scope, ambiguity, and responsibility.

```mermaid
flowchart LR
    Junior["Junior: perform"] --> Middle["Middle: choose boundaries"]
    Middle --> Senior["Senior: protect invariants"]
    Senior --> Professional["Professional: lead delivery"]
```
