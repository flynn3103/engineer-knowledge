# DevSecOps and Supply Chain Security — Senior
...
design make secure delivery repeatable from source to deployed artifact across components under failure and change. In this module, the important vocabulary is **dependency provenance, scanning, and signed builds**. Security work is useful only when the system makes the intended decision reliably and produces evidence that it did so.
