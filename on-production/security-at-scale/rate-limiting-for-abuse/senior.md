# Rate Limiting for Abuse — Senior
...
design bound abusive or accidental demand fairly and predictably across components under failure and change. In this module, the important vocabulary is **quotas, token buckets, and identity keys**. Security work is useful only when the system makes the intended decision reliably and produces evidence that it did so.
