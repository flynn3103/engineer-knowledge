...
design keep legitimate traffic working during a volumetric or application-layer attack across components under failure and change. In this module, the important vocabulary is **capacity, filtering, and incident controls**. Security work is useful only when the system makes the intended decision reliably and produces evidence that it did so.
