# DevSecOps and Supply Chain Security — Middle
...
choose maintainable boundaries for make secure delivery repeatable from source to deployed artifact in a real codebase. In this module, the important vocabulary is **dependency provenance, scanning, and signed builds**. Security work is useful only when the system makes the intended decision reliably and produces evidence that it did so.
