# Threat Modeling with STRIDE — Senior
...
design find and prioritize security threats before implementation across components under failure and change. In this module, the important vocabulary is **assets, trust boundaries, and STRIDE categories**. Security work is useful only when the system makes the intended decision reliably and produces evidence that it did so.
