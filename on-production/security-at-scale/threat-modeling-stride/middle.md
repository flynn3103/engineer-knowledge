# Threat Modeling with STRIDE — Middle
...
choose maintainable boundaries for find and prioritize security threats before implementation in a real codebase. In this module, the important vocabulary is **assets, trust boundaries, and STRIDE categories**. Security work is useful only when the system makes the intended decision reliably and produces evidence that it did so.
