...
This makes release notes a **quality gate** alongside tests and coverage. See Quality Gates for the gate-design patterns this reuses, and [Release Automation](../release-automation/README.md) for wiring it into the pipeline.
