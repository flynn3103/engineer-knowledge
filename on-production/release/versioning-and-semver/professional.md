...
See [Artifact Signing & Provenance](../artifact-signing-and-provenance/README.md) and [Supply Chain Security](../supply-chain-security/README.md) for the attestation machinery these version guarantees underpin.
