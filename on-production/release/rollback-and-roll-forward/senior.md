...
- **Retention is enforced and verified.** The previous N artifacts are pinned in the registry and protected from GC. A scheduled job actually pulls and runs the N-1 image to confirm it still starts. (Immutability and retention live in [Registries & Distribution](../registries-and-distribution/senior.md).)
