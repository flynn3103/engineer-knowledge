# Supply-Chain Security — Professional

<!-- level-focus -->
At professional level, focus on this question:

> How should teams adopt and operate **Supply-Chain Security** with measurable outcomes and limited coordination?
...
A representative policy (the *intent*, not signing internals — those are in [topic 04](../artifact-signing-and-provenance/README.md)):
...
1. Define the user or business outcome that **Supply-Chain Security** should improve.
...
- Which measurable outcome justifies investing in Supply-Chain Security?
