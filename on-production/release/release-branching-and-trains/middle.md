...
- **Why high-velocity teams left GitFlow:**
  ...
  - The price of trunk-based is discipline: incomplete work must hide behind **feature flags** rather than long-lived branches (see [Feature Flags & Progressive Delivery](../feature-flags-and-progressive-delivery/README.md)).
