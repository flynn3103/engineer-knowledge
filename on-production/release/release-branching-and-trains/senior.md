...
- **Flags are debt too.** Stale flags rot; you need a flag-retirement discipline. (See [Feature Flags & Progressive Delivery](../feature-flags-and-progressive-delivery/README.md).)
...
- **Promotion is auditable.** Each transition records the digest, the gate evidence, and the approver — this is also your provenance trail ([Artifact Signing & Provenance](../artifact-signing-and-provenance/README.md)).
...
- **Changelog/release-note assembly** from merged PRs ([02](../changelogs-and-release-notes/README.md)).
- **Freeze enforcement** as branch-protection rules, not Slack reminders.

Leave to humans: go/no-go on gates, exception decisions, and "is this the release we want to ship." Automate the toil, not the judgment. (See [Release Automation](../release-automation/README.md) and the `ci-cd-pipeline-design` skill.)
