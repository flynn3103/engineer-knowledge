...
> This is the input contract. The discipline cost is real: everyone on the team has to write commits this way. The payoff is that the version and changelog become free, automatic, and never wrong. See [Changelogs and Release Notes](../changelogs-and-release-notes/README.md) for how the changelog gets shaped.
