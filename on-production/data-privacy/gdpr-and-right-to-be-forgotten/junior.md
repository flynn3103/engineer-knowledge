...
They share the hardest sub-problem — **finding every place the subject's data lives** — which is why [PII and Data Classification](../pii-and-data-classification/README.md) is a prerequisite, not optional reading. You can't erase, export, or port data you don't know you're holding.
