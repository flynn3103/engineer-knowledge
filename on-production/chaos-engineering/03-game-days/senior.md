...
| **Continuous automated chaos** (see [Resilience Testing](../04-resilience-testing/senior.md)) | Runs on every deploy; catches regressions immediately, at near-zero marginal cost | Can't evaluate whether a *human* would have made the right call under pressure |
